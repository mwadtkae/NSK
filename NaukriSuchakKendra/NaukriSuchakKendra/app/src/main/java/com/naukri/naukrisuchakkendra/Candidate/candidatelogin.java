...
public class candidatelogin extends AppCompatActivity {
    ...
    String URl_Login1 = "http://naukri.giggadaproducts.com/product/Api/candidate/cdlogin.php";
    ...
    private void userLogin1() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(obj.optString("responce").equals("success")) {
                                ...
                                userid=jsonObject1.getString("c_id");
                                username=jsonObject1.getString("c_name");
                                ...
                                Intent i = new Intent(candidatelogin.this, Recomandjobs.class);
                                startActivity(i);
                ...
                },new Response.ErrorListener()
        {
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                Toast.makeText(getApplicationContext(),"Faileur("+error.networkResponse.statusCode+")",Toast.LENGTH_LONG).show();
